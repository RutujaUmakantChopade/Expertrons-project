...
const AdminMessage : React.FC<{message : MessageModal , submitResponseToQuestion :any}> =(props , key) =>{
  const [displayWarning , setDisplayingWaring] = useState(false)
  ...
  function submitBtn(){
    if(props.message.id !== null && response !== ''){
      ...
      setDisplayingWaring(false)
    }else{
      setDisplayingWaring(true)
    }
  }
      ...
      <div className='card mt-2 shadow p-3 bg-body rounded'>
        ...
        <div>
            ...
            <form action='PUT'>
                ...
                <div>
                    <button type='button' className='btn btn-primary mt-3' onClick={submitBtn}>Submit</button>
                </div>
            </form>
        </div>
      </div>
