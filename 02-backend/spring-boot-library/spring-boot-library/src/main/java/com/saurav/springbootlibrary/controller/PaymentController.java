...
import com.saurav.springbootlibrary.service.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<String> createPaymentIntent(@RequestBody PaymentInfoRequests paymentInfoRequests)throws StripeException {
        PaymentIntent paymentIntent = paymentService.createPaymentIntent(paymentInfoRequests);
